...
if (is_windows) {
  ...
  cargo_cfg <- paste0(
    "# Auto-generated by tools/config.R at install time.  Do not edit.\n",
  ...
  cargo_dir <- "src/.cargo"
  dir.create(cargo_dir, showWarnings = FALSE, recursive = TRUE)
  writeLines(cargo_cfg, file.path(cargo_dir, "config.toml"))
  message("Wrote linker config to src/.cargo/config.toml (linker: ", linker, ")")
}
