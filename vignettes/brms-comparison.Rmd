...
1. **Baseline (random intercept)** — a random intercept on `b0` with all
   structural parameters scalar (`~ 1`). Compared against **brms**.
...
4. **Multi-breakpoint** — two true change-points, single group / fixed
   effects; smoothbp vs brms, showing overlapping posterior distributions.
...
# Scenario 1: Baseline model (random intercept, scalar parameters)
