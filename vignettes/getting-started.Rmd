...
clean data frame. By default, `effects = "all"` is used. 
...
```{r summary}
print(fit1)                                        # prints all sections
print(fit1, effects = "fixed")                     # population-level only
summary(fit1, effects = "fixed")                   # same, but returns a data frame
summary(fit1, effects = c("fixed", "ran_pars"))    # fixed + sigma_u, omits the u[j] values
```
