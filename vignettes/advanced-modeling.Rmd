...
# By passing a formula with an intercept, we specify that the intercept (the global 
# mean) should have the spaced priors, while random effects are handled automatically.
