...
rally_omegas <- data.frame(
  ...
  filter(NVDA >= 1, NVDA <= 15, MSFT >= 1, MSFT <= 15, AAPL >= 1, AAPL <= 15)

if (nrow(rally_omegas) > 0) {
  ...
  message("No draws found where the rally event fell within the observed data range for all tickers.")
}
```
